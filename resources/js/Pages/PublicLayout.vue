                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6">
                    <div
                        ...
                        <nav class="hidden md:flex space-x-10">
                            ...
                            <div @click="openDrop = !openDrop" class="relative">
                                <button type="button"
                                        :class="{ 'text-gray-900': flyoutMenuOpen, 'text-gray-500': !flyoutMenuOpen }"
                                        class="group inline-flex items-center space-x-2 text-base leading-6 font-medium hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150 text-gray-900">
                                    <span>Scholarships</span>
                                    <svg
                                        class="h-5 w-5 group-hover:text-gray-500 group-focus:text-gray-500 transition ease-in-out duration-150 text-gray-600"
                        ...
                        <div class="hidden md:flex items-center justify-end space-x-8 md:flex-1 lg:w-0">
                            <Link :href="route('login')" href="#"
                               class="rounded-xl bg-purple-800 px-5 py-3 text-base mb-3 font-medium text-white transition duration-200 hover:bg-purple-600 active:bg-brand-700">
                                Sign up
                            </Link>
                        </div>
                    </div>
